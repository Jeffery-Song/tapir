...
import com.yahoo.ycsb.generator.RangeGenerator;
import com.yahoo.ycsb.generator.RangeZipfianGenerator;
// import com.yahoo.ycsb.generator.RangeCounterGenerator;
 ...
 * </ul> 
 */
public class RangeWorkload extends Workload
{
    public int cnt = 0;
    ...
    {
        ranges = p.getProperty(RANGES, "").split(",");
        rangesize = Integer.parseInt(p.getProperty(RANGE_SIZE, "0"));
        formatstring_ = "%0" + (("" + (rangesize-1)).length()) + "d";

        table = p.getProperty(TABLENAME_PROPERTY,TABLENAME_PROPERTY_DEFAULT);
        
        fieldcount=Integer.parseInt(p.getProperty(FIELD_COUNT_PROPERTY,FIELD_COUNT_PROPERTY_DEFAULT));
        fieldlengthgenerator = RangeWorkload.getFieldLengthGenerator(p);
        ...
        int insertstart = Integer.parseInt(p.getProperty("rangestart", "0")) * Integer.parseInt(p.getProperty("rangesize", "0"));
        ...
        //                                 System.err.println("using expoential distribution");
        ...
        rangeIndexSelector =new CounterGenerator(0);
        // keysequence=new RangeCounterGenerator(Integer.parseInt(p.getProperty(RANGE_SIZE, "0")), p.getProperty(RANGES, "").split(","));
    ...
    public String formatKey(int rangeIndex, int offset) {
        return ranges[rangeIndex] + String.format(formatstring_, offset);
    }
